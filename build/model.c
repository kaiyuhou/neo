#define exit(...) verify_exit(__VA_ARGS__)
#define main(...) spin_main(__VA_ARGS__)
/*** Generated by Spin Version 6.5.1 -- 31 July 2020 ***/
/*** From source: /root/neo-kaiyu/src/network.pml ***/
...
short src_ln0 [] = {
	  0,  72,  77,  78,  78,  78,  78,  78, 
	 79,  78,  79,  82,  82,  76,  85,  76, 
	 85,  88,  89,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "/root/neo-kaiyu/src/network.pml", 1, 18 },
	{ "-", 19, 20 }
};
uchar reached0 [] = {
	  0,   0,   1,   0,   1,   0,   1,   0, 
...
struct {
	...
	{ "c_code4", "        report(&now);\n    " },
	{ "c_code3", "            exec_step(&now);\n        " },
	{ "c_code2", "        initialize(&now);\n    " },
	{ "c_code1", "    \n#include \"api.hpp\"\n" },
	{ (char *) 0, "" }
};
...
iniglobals(int calling_pid)
{
		...
		now.comm = 0;
		now.num_comms = 0;
		now.correlated_policy_idx = 0;
		now.choice = 0;
		now.choice_count = 0;
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.candidates[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[0].fib[l_in] = 0;
		}
	}
		now.comm_state[0].process_id = 0;
		now.comm_state[0].pkt_state = 0;
		now.comm_state[0].fwd_mode = 0;
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[0].ec[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 1; l_in++)
		{
			now.comm_state[0].src_ip[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 1; l_in++)
		{
			now.comm_state[0].seq[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 1; l_in++)
		{
			now.comm_state[0].ack[l_in] = 0;
		}
	}
		now.comm_state[0].src_port = 0;
		now.comm_state[0].dst_port = 0;
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[0].src_node[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[0].tx_node[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[0].rx_node[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[0].pkt_hist[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[0].pkt_location[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[0].ingress_intf[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[0].path_choices[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[0].openflow_update_state[l_in] = 0;
		}
	}
		now.comm_state[0].repetition = 0;
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[1].fib[l_in] = 0;
		}
	}
		now.comm_state[1].process_id = 0;
		now.comm_state[1].pkt_state = 0;
		now.comm_state[1].fwd_mode = 0;
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[1].ec[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 1; l_in++)
		{
			now.comm_state[1].src_ip[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 1; l_in++)
		{
			now.comm_state[1].seq[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 1; l_in++)
		{
			now.comm_state[1].ack[l_in] = 0;
		}
	}
		now.comm_state[1].src_port = 0;
		now.comm_state[1].dst_port = 0;
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[1].src_node[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[1].tx_node[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[1].rx_node[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[1].pkt_hist[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[1].pkt_location[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[1].ingress_intf[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[1].path_choices[l_in] = 0;
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			now.comm_state[1].openflow_update_state[l_in] = 0;
		}
	}
		now.comm_state[1].repetition = 0;
#ifdef VAR_RANGES
		logval("violated", now.violated);
		logval("comm", now.comm);
		logval("num_comms", now.num_comms);
		logval("correlated_policy_idx", now.correlated_policy_idx);
		logval("choice", now.choice);
		logval("choice_count", now.choice_count);
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("candidates[l_in]", now.candidates[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[0].fib[l_in]", now.comm_state[0].fib[l_in]);
		}
	}
		logval("comm_state[0].process_id", now.comm_state[0].process_id);
		logval("comm_state[0].pkt_state", now.comm_state[0].pkt_state);
		logval("comm_state[0].fwd_mode", now.comm_state[0].fwd_mode);
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[0].ec[l_in]", now.comm_state[0].ec[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 1; l_in++)
		{
			logval("comm_state[0].src_ip[l_in]", now.comm_state[0].src_ip[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 1; l_in++)
		{
			logval("comm_state[0].seq[l_in]", now.comm_state[0].seq[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 1; l_in++)
		{
			logval("comm_state[0].ack[l_in]", now.comm_state[0].ack[l_in]);
		}
	}
		logval("comm_state[0].src_port", now.comm_state[0].src_port);
		logval("comm_state[0].dst_port", now.comm_state[0].dst_port);
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[0].src_node[l_in]", now.comm_state[0].src_node[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[0].tx_node[l_in]", now.comm_state[0].tx_node[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[0].rx_node[l_in]", now.comm_state[0].rx_node[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[0].pkt_hist[l_in]", now.comm_state[0].pkt_hist[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[0].pkt_location[l_in]", now.comm_state[0].pkt_location[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[0].ingress_intf[l_in]", now.comm_state[0].ingress_intf[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[0].path_choices[l_in]", now.comm_state[0].path_choices[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[0].openflow_update_state[l_in]", now.comm_state[0].openflow_update_state[l_in]);
		}
	}
		logval("comm_state[0].repetition", now.comm_state[0].repetition);
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[1].fib[l_in]", now.comm_state[1].fib[l_in]);
		}
	}
		logval("comm_state[1].process_id", now.comm_state[1].process_id);
		logval("comm_state[1].pkt_state", now.comm_state[1].pkt_state);
		logval("comm_state[1].fwd_mode", now.comm_state[1].fwd_mode);
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[1].ec[l_in]", now.comm_state[1].ec[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 1; l_in++)
		{
			logval("comm_state[1].src_ip[l_in]", now.comm_state[1].src_ip[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 1; l_in++)
		{
			logval("comm_state[1].seq[l_in]", now.comm_state[1].seq[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 1; l_in++)
		{
			logval("comm_state[1].ack[l_in]", now.comm_state[1].ack[l_in]);
		}
	}
		logval("comm_state[1].src_port", now.comm_state[1].src_port);
		logval("comm_state[1].dst_port", now.comm_state[1].dst_port);
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[1].src_node[l_in]", now.comm_state[1].src_node[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[1].tx_node[l_in]", now.comm_state[1].tx_node[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[1].rx_node[l_in]", now.comm_state[1].rx_node[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[1].pkt_hist[l_in]", now.comm_state[1].pkt_hist[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[1].pkt_location[l_in]", now.comm_state[1].pkt_location[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[1].ingress_intf[l_in]", now.comm_state[1].ingress_intf[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[1].path_choices[l_in]", now.comm_state[1].path_choices[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			logval("comm_state[1].openflow_update_state[l_in]", now.comm_state[1].openflow_update_state[l_in]);
		}
	}
		logval("comm_state[1].repetition", now.comm_state[1].repetition);
#endif
}
...
{	/* int i; */
	printf("global vars:\n");
		printf("	(struct comm_state)\n");
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    fib[%d]:	%d\n", l_in, now.comm_state[ 0 ].fib[l_in]);
		}
	}
	printf("	unsigned  process_id:	%d\n", now.comm_state[ 0 ].process_id);
	printf("	unsigned  pkt_state:	%d\n", now.comm_state[ 0 ].pkt_state);
	printf("	unsigned  fwd_mode:	%d\n", now.comm_state[ 0 ].fwd_mode);
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    ec[%d]:	%d\n", l_in, now.comm_state[ 0 ].ec[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 1; l_in++)
		{
			printf("	int    src_ip[%d]:	%d\n", l_in, now.comm_state[ 0 ].src_ip[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 1; l_in++)
		{
			printf("	int    seq[%d]:	%d\n", l_in, now.comm_state[ 0 ].seq[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 1; l_in++)
		{
			printf("	int    ack[%d]:	%d\n", l_in, now.comm_state[ 0 ].ack[l_in]);
		}
	}
	printf("	unsigned  src_port:	%d\n", now.comm_state[ 0 ].src_port);
	printf("	unsigned  dst_port:	%d\n", now.comm_state[ 0 ].dst_port);
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    src_node[%d]:	%d\n", l_in, now.comm_state[ 0 ].src_node[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    tx_node[%d]:	%d\n", l_in, now.comm_state[ 0 ].tx_node[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    rx_node[%d]:	%d\n", l_in, now.comm_state[ 0 ].rx_node[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    pkt_hist[%d]:	%d\n", l_in, now.comm_state[ 0 ].pkt_hist[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    pkt_location[%d]:	%d\n", l_in, now.comm_state[ 0 ].pkt_location[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    ingress_intf[%d]:	%d\n", l_in, now.comm_state[ 0 ].ingress_intf[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    path_choices[%d]:	%d\n", l_in, now.comm_state[ 0 ].path_choices[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    openflow_update_state[%d]:	%d\n", l_in, now.comm_state[ 0 ].openflow_update_state[l_in]);
		}
	}
	printf("	int    repetition:	%d\n", now.comm_state[ 0 ].repetition);
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    fib[%d]:	%d\n", l_in, now.comm_state[ 1 ].fib[l_in]);
		}
	}
	printf("	unsigned  process_id:	%d\n", now.comm_state[ 1 ].process_id);
	printf("	unsigned  pkt_state:	%d\n", now.comm_state[ 1 ].pkt_state);
	printf("	unsigned  fwd_mode:	%d\n", now.comm_state[ 1 ].fwd_mode);
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    ec[%d]:	%d\n", l_in, now.comm_state[ 1 ].ec[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 1; l_in++)
		{
			printf("	int    src_ip[%d]:	%d\n", l_in, now.comm_state[ 1 ].src_ip[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 1; l_in++)
		{
			printf("	int    seq[%d]:	%d\n", l_in, now.comm_state[ 1 ].seq[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 1; l_in++)
		{
			printf("	int    ack[%d]:	%d\n", l_in, now.comm_state[ 1 ].ack[l_in]);
		}
	}
	printf("	unsigned  src_port:	%d\n", now.comm_state[ 1 ].src_port);
	printf("	unsigned  dst_port:	%d\n", now.comm_state[ 1 ].dst_port);
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    src_node[%d]:	%d\n", l_in, now.comm_state[ 1 ].src_node[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    tx_node[%d]:	%d\n", l_in, now.comm_state[ 1 ].tx_node[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    rx_node[%d]:	%d\n", l_in, now.comm_state[ 1 ].rx_node[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    pkt_hist[%d]:	%d\n", l_in, now.comm_state[ 1 ].pkt_hist[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    pkt_location[%d]:	%d\n", l_in, now.comm_state[ 1 ].pkt_location[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    ingress_intf[%d]:	%d\n", l_in, now.comm_state[ 1 ].ingress_intf[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    path_choices[%d]:	%d\n", l_in, now.comm_state[ 1 ].path_choices[l_in]);
		}
	}
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    openflow_update_state[%d]:	%d\n", l_in, now.comm_state[ 1 ].openflow_update_state[l_in]);
		}
	}
	printf("	int    repetition:	%d\n", now.comm_state[ 1 ].repetition);
	printf("	bit    violated:	%d\n", now.violated);
	printf("	int    comm:	%d\n", now.comm);
	printf("	int    num_comms:	%d\n", now.num_comms);
	printf("	int    correlated_policy_idx:	%d\n", now.correlated_policy_idx);
	printf("	int    choice:	%d\n", now.choice);
	printf("	int    choice_count:	%d\n", now.choice_count);
	{	int l_in;
		for (l_in = 0; l_in < 2; l_in++)
		{
			printf("	int    candidates[%d]:	%d\n", l_in, now.candidates[l_in]);
		}
	}
}
void
